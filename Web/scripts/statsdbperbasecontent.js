...
function readStatsdbperbasecontent(jsonfile) {
    ...
    jQuery("#statschartperbasecontentbutton").html("<button type=\"button\" onClick=jQuery('.lineA').toggle();jQuery('.circleA').toggle();> <b><font color=red>A </font></b></button> " +
    ...
    var w = $("#statschartperbasecontent").width();
